...
from cidautai_va_v2_mid2 import DarkIRFusion, DarkIRFusionLoss
...
def train(num_threads=1, cuda=True, restart_train=False, mGPU=False):
    ...
    output_dir = 'output_v2_mid2_800'
    logs_dir = 'logs_dir_v2_mid2_800'
    ...
    if not restart_train:
        try:
            ckpt = load_checkpoint('checkpoint_dir_v2_800_warm_restart', 'best')
            start_epoch = 0
